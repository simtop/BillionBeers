...
plugins {
    ...
    // Existing plugins from beer_data/build.gradle.kts
    id("org.jetbrains.kotlin.plugin.compose")
}

android {
    namespace = "com.example.billionbeers.beer_data" // Module-specific
...
dependencies {
    ...
    androidTestImplementation(libs.coroutinesTest) // Duplicated in original file, kept once
    ...
    androidTestImplementation(libs.mockkAndroid) // Duplicated in original file, kept once
    androidTestImplementation(libs.junitKtx)
    androidTestImplementation(libs.navigationTesting)

    androidTestImplementation(libs.coreTesting) // Duplicated in original file, kept once
    androidTestImplementation(libs.fragmentTesting)

    // Dependencies from the original beer_data/build.gradle.kts
    implementation(project(":core")) // Already listed in convention (libs.coreKtx is core, but this is project(":core")) - this is distinct
