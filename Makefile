...
desktop-package-test: ## Test the Desktop distribution verifiers without building a package.
	python3 scripts/test_verify_desktop_distribution.py
	python3 scripts/test_smoke_desktop_distribution.py

desktop-package-smoke: desktop-package ## Launch and smoke-test the packaged macOS arm64 Desktop CLI.
	python3 scripts/smoke_desktop_distribution.py "$(DESKTOP_APP_DIR)"
...
# under test.
KMP_JVM_TEST_MODULES := :core-common :beerdomain:api :beerdomain:fakes :beer_network:api :beer_network :beer_storage:api :beer_database :beer_data :ios-shared :compose-multiplatform-fixture :shared:designsystem :shared:presentation :shared:favorites :shared:beerslist :shared:beersearch :shared:beerdetail :shared:beerbrowse :shared:app :navigation-contract
KMP_METADATA_MODULES := :core-common :beerdomain:api :beerdomain:fakes :beer_network:api :beer_network :beer_network:fixtures :beer_storage:api :beer_database :beer_data :compose-multiplatform-fixture :shared:designsystem :shared:presentation :shared:favorites :shared:beerslist :shared:beersearch :shared:beerdetail :shared:beerbrowse :shared:app :navigation-contract
KMP_ANDROID_HOST_TEST_MODULES := :core-common :beerdomain:api :beerdomain:fakes :beer_network:api :beer_network :beer_storage:api :beer_database :beer_data :compose-multiplatform-fixture :shared:designsystem :shared:presentation :shared:favorites :shared:beerslist :shared:beersearch :shared:beerdetail :shared:beerbrowse :shared:app :navigation-contract
KMP_BROWSER_TEST_MODULES := :beer_storage:browser :web-app :compose-multiplatform-fixture :shared:presentation :shared:favorites :shared:beerslist :shared:beersearch :shared:beerdetail :shared:beerbrowse :shared:app :navigation-contract
