...
plugins {
    ...
    // Existing plugins from beer_network/build.gradle.kts
    id("org.jetbrains.kotlin.plugin.compose")
}

android {
    namespace = "com.example.billionbeers.beer_network" // Module-specific
...
dependencies {
    ...
    // Dependencies from the original beer_network/build.gradle.kts
